...
[ ] = { { ( char_T * ) ( & rtB . akyt3lfkwh ) , 0 , 0 , 23 } , { ( char_T * )
( & rtDW . exeralr4po ) , 0 , 0 , 5 } , { ( char_T * ) ( & rtDW . jqrqq3twqe
. TimePtr ) , 11 , 0 , 6 } , { ( char_T * ) ( & rtDW . h1nceqotqd . PrevIndex
) , 10 , 0 , 15 } } ; static DataTypeTransitionTable rtBTransTable = { 4U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . PVArray_Npar ) , 0 , 0 , 1987 } , { ( char_T * ) ( & rtP
. u_CurrentSetting ) , 3 , 0 , 10 } } ; static DataTypeTransitionTable
